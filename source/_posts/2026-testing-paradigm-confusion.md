...
2017 年，intern 時期跟另外 3 名 intern 一起維運著公司的人才庫系統，認識了 91（[Joey Chen](https://tdd.best/about/)，不是 91APP），受到了很多的啟發，也是我決定了解敏捷文化的契機
...
照片中的模型是從 intern 畢業時收到的禮物](../img/2026-testing-paradigm-confusion/image.png)
> *Tamama 的來由：在一部叫做《Keroro 軍曹》的動畫，裡面有一個見習的二等兵角色叫做 Tamama
...
1. 公司正在導入敏捷，我很想親眼看看「導入敏捷」在真實世界裡到底會發生什麼事，這在當時的氛圍下對我超有吸引力
2. 我那時對 QA 的想像就是「測試」，而測試需要的能力面向很廣，剛好很符合我的個性。

加入公司之前，我去參加了至少 2 場 Agile meetup，去問了各個業界的前輩關於如何當一個好的 QA/QE，得到了許多的 feedback，感謝當時的自己寫下了一些筆記，或許可以找個時間來寫一個現在我對於測試工作的一些看法（挖坑）

第一份工作開始沒多久，我就成了公司裡蠻受關注的新人。原因很簡單，我跟當時公司裡其他測試人員不太一樣，我會一直用自己擁有的開發者技能，去做一些能輔助測試、也能幫到團隊的工具。那時候的我像海綿一樣，瘋狂閱讀、吸收測試相關知識，也很常在團隊裡主動嘗試新做法，例如舉辦 Bug Bash、Coding Dojo…等。這裡也要特別感謝當時的 Test Team Lead Matt，願意鼓勵我去做這些事

那段時間下班後，我常常會跟 Ruddy 老師一起走到松山捷運站搭車回家。我們回家的路線剛好重疊，我住紅線的忠義站，中間還要從綠線轉紅線，所以我們甚至會一路討論怎麼轉乘比較快。更重要的是，路上我們會聊很多關於公司、敏捷轉型的事情，我收穫非常多。現在回想起來我也不知道自己哪來那麼多勇氣一直問、一直聊，哈哈哈，唯一可惜的是，當時沒有留下文字紀錄
...
但這段經驗，卻奠定了我後來對測試環境建置與使用的一些想法。會開始重視「環境」這件事，也跟 Rick 有關，畢竟我算是看著 Rick 的部落格長大的（？），其中[那篇文章](https://rickhw.github.io/2015/10/11/SQA/How-To-Be-An-SQA/)讓我更清楚建立環境的重要性
...
![](../img/2026-testing-paradigm-confusion/takingTestingSeriously.jpg)

直到 2025 年 11 月，James Bach 以及 Michael Bolton 的著作 [*《Taking Testing Seriously》*](https://www.tenlong.com.tw/products/9781394253197)發表了出來，看完了第一章之後才理解原來我的疑惑正是關於測試的「思想學派」之間的衝突，下面是我將書中內容丟給 AI 做的翻譯（有些小地方我有調整一點用詞）
...
每一個思想學派都是一種**典範（paradigm）**——也就是一個包山包海的世界觀。科學中「典範」這個概念，最早是由 Thomas Kuhn 在其經典著作 *The Structure of Scientific Revolutions《科學革命的結構》*中提出的。
...
那我們為什麼要寫這麼多哲學？是為了**讓你先做好準備**。本書描述的測試文化，很可能跟你在一般軟體專案裡觀察到的、或在網路上看測試 demo 所吸收到的很不一樣。Context-Driven 的方式不只是一種方法：它同時也是一種典範、一種文化、一種生活形式。

看看書名吧。準備好**認真看待測試 (Preparing to taking testing seriously)**
...
我們在情境驅動典範裡相信：**人、啟發式、技能、倫理**才是核心，因為這能找出更多 bug、也找出更重要的 bug；能吸引更有天份的人投入測試；也能讓社會更好。對我們而言最難的謎題是：如何訓練與管理測試者，讓他們能在一個主要只在乎快速賺錢、並希望測試是一套固定演算法而不是開放式調查的世界裡運作。
...
正如[邱威傑在 TED Talk](https://www.youtube.com/watch?v=m9tNBHBKMpU&t=1s) 所說：「人生沒有一條路是白走的」，我相信接下來的職涯，會讓我更清楚自己真正想走的路會長成什麼樣子
...
![image.png](../img/2026-testing-paradigm-confusion/image%201.png)
