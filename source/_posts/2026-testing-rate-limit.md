...
根據上列的測試想法，就可以開始建立測試模型了，驗證重點的代碼對應上方清單
...
列到這裡大致上的「測試想法」都涵蓋到了
在列這個測試模型的時候很容易腦子裡的邏輯會打架，在列舉的同時會衍伸很多想法，例如
...
所以測試 Rate limit 的本質就是在驗證系統在流量超過設計上限時，是否能用可預期、可控制的方式拒絕請求，同時維持整體服務穩定與公平性的一個功能測試
