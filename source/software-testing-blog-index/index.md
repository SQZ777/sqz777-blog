...
layout: software-testing-blog
description: 我過去撰寫的軟體測試部落格文章索引，整理了測試思維、測試自動化、API 測試、Bug Bash、測試文件與品質工程相關筆記。
keywords:
  - 軟體測試台灣部落格
  - 軟體測試部落格
  - 台灣軟體測試
...
<section class="testing-index-intro">
  <p>這裡整理我在台灣軟體產品團隊做測試工作的文章。主題包含測試思維、品質判斷、團隊協作、測試自動化與測試文件。</p>
  <p>如果你正在找「軟體測試 台灣 部落格」或「軟體測試 部落格」，可以先從下面幾篇開始。</p>
</section>

<nav class="testing-index-nav" aria-label="文章分類">
  <a href="#thinking">測試思維與職涯</a>
  <a href="#practice">測試實務與工具</a>
  <a href="#team">團隊測試與文件</a>
  <a href="#next">之後可以寫</a>
</nav>

<section class="testing-index-section" id="thinking">
  <div class="testing-section-heading">
    <span>Path 01</span>
    <h2>測試思維與職涯</h2>
  </div>
...
<section class="testing-index-section" id="practice">
  <div class="testing-section-heading">
    <span>Path 02</span>
    <h2>測試實務與工具</h2>
  </div>
...
<section class="testing-index-section" id="team">
  <div class="testing-section-heading">
    <span>Path 03</span>
    <h2>團隊測試與測試文件</h2>
  </div>
  <div class="testing-article-grid">
    <a class="testing-article-card" href="/2018/02/27/2018-195303">
      <span class="testing-card-tag">Bug Bash</span>
      <h3>Bug Bash 實戰：讓團隊一起參與軟體測試</h3>
      <p>分享第一次在敏捷團隊舉辦 Bug Bash / Test Together 的經驗與回饋。</p>
      <span class="testing-card-link">閱讀文章</span>
    </a>
    <a class="testing-article-card" href="/2018/03/10/2018-234606">
...
<section class="testing-index-section" id="next">
  <div class="testing-section-heading">
    <span>Next</span>
    <h2>之後值得補上的文章</h2>
  </div>
  <div class="testing-suggestion-grid">
    <article class="testing-suggestion-card">
      <h3>James Bach</h3>
      <p>可以從探索式測試、context-driven testing、testing as performance，以及他如何影響你對測試的理解切入。</p>
    </article>
    <article class="testing-suggestion-card">
      <h3>Cem Kaner</h3>
      <p>可以承接測試技術分類系統，寫他對 software testing、context-driven testing 與法律/品質觀點的影響。</p>
    </article>
    <article class="testing-suggestion-card">
      <h3>Michael Bolton</h3>
      <p>可以寫 Rapid Software Testing、checking vs testing、measurement 與測試溝通。</p>
    </article>
    <article class="testing-suggestion-card">
      <h3>Rikard Edgren / The Test Eye</h3>
      <p>可以接續「測試有關的難搞事」，整理測試價值與測試策略的實務觀點。</p>
    </article>
  </div>
</section>
